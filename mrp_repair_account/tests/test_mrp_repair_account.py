...
class TestMrpRepairStock(TransactionCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.stock_location_repair = self.env.ref(
            'mrp_repair_account.stock_location_repair')
        self.stock_location_repair_warranty = self.env.ref(
            'mrp_repair_account.stock_location_repair_warranty')
        self.stock_location_repair_internal = self.env.ref(
            'mrp_repair_account.stock_location_repair_internal')
        ...
        self.mrp_repair_type_warranty = self.env.ref(
            'mrp_repair_account.mrp_repair_type_warranty')
        self.mrp_repair_type_internal = self.env.ref(
            'mrp_repair_account.mrp_repair_type_internal')
        self.mrp_repair_type_refurbish = self.env.ref(
            'mrp_repair_account.mrp_repair_type_refurbish')
        ...
        self.cogr_acc = self.env.ref(
            'mrp_repair_account.demo_account_cogr')
        self.uwr_acc = self.env.ref(
            'mrp_repair_account.demo_account_uwr')
        self.off_acc = self.env.ref(
            'mrp_repair_account.demo_account_ofs')
        self.refurbish_acc = self.env.ref(
            'mrp_repair_account.demo_account_refr')
        self.labor_all_acc = self.env.ref(
            'mrp_repair_account.demo_account_labor_all')
        self.oh_all_acc = self.env.ref(
            'mrp_repair_account.demo_account_overhead_all')
