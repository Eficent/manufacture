...
class TestMrpRepairStock(TransactionCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.stock_location_repair = self.env.ref(
            'mrp_repair_cost.stock_location_repair')
        self.stock_location_repair_warranty = self.env.ref(
            'mrp_repair_cost.stock_location_repair_warranty')
        self.stock_location_repair_internal = self.env.ref(
            'mrp_repair_cost.stock_location_repair_internal')
        self.stock_location_repair_refurbish = self.env.ref(
            'mrp_repair_cost.stock_location_repair_refurbish')
        self.refurbish_location = self.env.ref(
            'mrp_repair_refurbish.stock_location_refurbish')
        self.repair_team = self.env.ref(
            'mrp_repair_cost.mrp_repair_team_dep1')
        self.default_raw_material_location_id = \
            self.repair_team.default_raw_material_location_id

        self.mrp_repair_type_no_warranty = self.env.ref(
            'mrp_repair_cost.mrp_repair_type_no_warranty')
        self.mrp_repair_type_warranty = self.env.ref(
            'mrp_repair_cost.mrp_repair_type_warranty')
        self.mrp_repair_type_internal = self.env.ref(
            'mrp_repair_cost.mrp_repair_type_internal')
        self.mrp_repair_type_refurbish = self.env.ref(
            'mrp_repair_cost.mrp_repair_type_refurbish')
        ...
        self.env.user.mrp_repair_team_id = self.repair_team.id

        self.cogr_acc = self.env.ref(
            'mrp_repair_cost.demo_account_cogr')
        self.uwr_acc = self.env.ref(
            'mrp_repair_cost.demo_account_uwr')
        self.off_acc = self.env.ref(
            'mrp_repair_cost.demo_account_ofs')
        self.refurbish_acc = self.env.ref(
            'mrp_repair_cost.demo_account_refr')
        self.labor_all_acc = self.env.ref(
            'mrp_repair_cost.demo_account_labor_all')
        self.oh_all_acc = self.env.ref(
            'mrp_repair_cost.demo_account_overhead_all')
        ...
        self.stock_location_repair_warranty.valuation_in_account_id = self.uwr_acc.id
        self.stock_location_repair_warranty.valuation_out_account_id = self.uwr_acc.id

        self.stock_location_repair_internal.valuation_in_account_id = self.off_acc.id
        self.stock_location_repair_internal.valuation_out_account_id = self.off_acc.id

        self.stock_location_repair_refurbish.valuation_in_account_id = self.refurbish_acc.id
        self.stock_location_repair_refurbish.valuation_out_account_id = self.refurbish_acc.id
    ...
    def test_01_repair_no_warranty(self):
        ...
        repair = self.repair_obj.create({
            ...
            'product_qty': 1.0,
            'type_id': self.mrp_repair_type_no_warranty.id,
        ...
        self.assertEqual(line.location_dest_id,
                         self.mrp_repair_type_no_warranty.
    ...
    def test_02_repair_under_warranty(self):
        ...
        repair = self.repair_obj.create({
            'product_id': self.product2.id,
            'product_qty': 1.0,
            'type_id': self.mrp_repair_type_warranty.id,
            'product_uom': self.product2.uom_id.id,
            'location_id': self.stock_location_rma_external.id,
            'location_dest_id': self.stock_location_rma_external.id,
        })
    ...
    def test_03_repair_under_internal(self):
        ...
        repair = self.repair_obj.create({
            'product_id': self.product2.id,
            'product_qty': 1.0,
            'type_id': self.mrp_repair_type_internal.id,
            'product_uom': self.product2.uom_id.id,
    ...
    def test_04_repair_refusrbish(self):
        ...
        repair = self.repair_obj.create({
            ...
            'product_qty': 1.0,
            'type_id': self.mrp_repair_type_refurbish.id,
        ...
        self.assertEqual(line.location_id,
                         self.repair_team.default_raw_material_location_id)
        self.assertEqual(line.location_dest_id,
                         self.mrp_repair_type_refurbish.
                         default_raw_material_prod_location_id)
        # Complete repair:
        repair.action_repair_ready()
        repair.action_repair_start()
        ...
        # 3+2 refusrbish +  1 cogr and labor allocation + 1 cogr and overhead allocation
        ...
        self.assertEqual(sum(amlinv.mapped('credit')), 20) # lost product to repair + original product
